...
// A PLACEHOLDER, and deliberately nothing more. The tab bar needs a third route
// to navigate to; this is the smallest thing that can be one. The real screen
...
const st = StyleSheet.create({
  ...
  // side, so the brand mark sits in the same column on all three screens.
